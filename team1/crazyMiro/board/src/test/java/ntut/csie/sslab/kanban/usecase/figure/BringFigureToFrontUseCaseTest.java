...
public class BringFigureToFrontUseCaseTest extends AbstractSpringBootJpaTest {
    ...
    public void bring_a_sticker_to_front(){
        ...
        FigureDto stickerDto3 = new FigureDto(null, "sticker3", 20, 10, "white", sticker3Position);
        FigureDto stickerDto4 = new FigureDto(null, "sticker4", 20, 10, "green", sticker4Position);
        FigureDto stickerDto5 = new FigureDto(null, "sticker5", 20, 10, "red", sticker5Position);
        String stickerId1 = createSticker(boardId1, stickerDto1.getContent(), stickerDto1.getWidth(), stickerDto1.getLength(), stickerDto1.getColor(), stickerDto1.getPosition());
        String stickerId2 = createSticker(boardId1, stickerDto2.getContent(), stickerDto2.getWidth(), stickerDto2.getLength(), stickerDto2.getColor(), stickerDto2.getPosition());
        String stickerId3 = createSticker(boardId1, stickerDto3.getContent(), stickerDto3.getWidth(), stickerDto3.getLength(), stickerDto3.getColor(), stickerDto3.getPosition());
        String stickerId4 = createSticker(boardId2, stickerDto4.getContent(), stickerDto4.getWidth(), stickerDto4.getLength(), stickerDto4.getColor(), stickerDto4.getPosition());
        String stickerId5 = createSticker(boardId2, stickerDto5.getContent(), stickerDto5.getWidth(), stickerDto5.getLength(), stickerDto5.getColor(), stickerDto5.getPosition());
        ...
        assertEquals(stickerId3, board1Stickers.get(1).getFigureId());
        assertEquals(1, board1Stickers.get(1).getOrder());
        assertEquals(stickerId1, board1Stickers.get(2).getFigureId());
        assertEquals(2, board1Stickers.get(2).getOrder());
        assertEquals(stickerId4, board2Stickers.get(0).getFigureId());
        assertEquals(0, board2Stickers.get(0).getOrder());
        assertEquals(stickerId5, board2Stickers.get(1).getFigureId());
        assertEquals(1, board2Stickers.get(1).getOrder());
