...
public abstract class AbstractSpringBootJpaTest {
    ...
    public Board2Repository board2Repository;
    ...
    public void setUp() {
        ...
        board2Repository = new Board2RepositoryImpl(boardRepositoryPeer);
        ...
        notifyBoardAdapter = new NotifyBoardAdapter(new NotifyBoard(board2Repository, domainEventBus));
        notifyWorkflowAdapter = new NotifyWorkflowAdapter(new NotifyWorkflow(cardRepository, workflowRepository, domainEventBus));

    }


    public CreateBoard2UseCase newCreateBoard2UseCase(){
        return new CreateBoard2UseCaseImpl(board2Repository, domainEventBus);
    }

    public GetBoardContentUseCase newGetBoardContentUseCase() {
        return new GetBoardContentUseCaseImpl(board2Repository, workflowRepository, cardRepository, domainEventBus);
    }
    ...
    public Board2Repository getBoardRepository(){
        return board2Repository;
    }
}
